/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b70ca8d843f08127d6020b54241808a7)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	STORAGE_KV_REST_API_READ_ONLY_TOKEN: string;
	STORAGE_KV_REST_API_TOKEN: string;
	STORAGE_KV_REST_API_URL: string;
	STORAGE_KV_URL: string;
	STORAGE_REDIS_URL: string;
	GITHUB_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STORAGE_KV_REST_API_READ_ONLY_TOKEN" | "STORAGE_KV_REST_API_TOKEN" | "STORAGE_KV_REST_API_URL" | "STORAGE_KV_URL" | "STORAGE_REDIS_URL" | "GITHUB_TOKEN" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN">> {}
}
